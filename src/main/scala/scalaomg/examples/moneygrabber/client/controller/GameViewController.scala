...
import scalaomg.examples.moneygrabber.client.view.game.GameView.{GameEnd, GameStarted}
...
import scalaomg.examples.moneygrabber.common.Entities.{Direction, Down, Left, Right, Up}
...
case class GameViewController(private val frame: GameFrame, private val room: JoinedRoom) extends Publisher {
  ...
  private def onGameEnd(gameState: Board): Unit = {
    SwingUtilities.invokeLater(() => {
      import scalaomg.examples.moneygrabber.client.view.utils.Utils._
